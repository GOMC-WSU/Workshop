...
vmd Butane_NVT_T_300K_merged.psf Butane_NVT_T_300K_BOX_0.pdb &
...
#    "0 Butane_NVT_T_300K_BOX_0.pdb".
# 2- Select the residue name that you want to calculate RDF. Type "type CH3" 
...
cat Blk_Butane_NVT_T_300K_BOX_0.dat | awk '{print $1 " " $2}' > energy.dat
