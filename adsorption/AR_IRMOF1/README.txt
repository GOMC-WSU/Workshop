...
# This command extracts the average number of AR molecules in the system.

cat Blk_AR_EDUSIF_*_BOX_0.dat | awk '{print $1, $10*$13}' > mol_AR_avg.dat

# The instantaneous number of AR molecules can be extracted via:

cat output_AR.log | awk '/STAT_0/ {print $2, $3*$5}' > mol_AR_fluct.dat

# Plot these data using xmgrace and compare them with histogram data gnerated by
# GOMC (n2dis1a.dat)

xmgrace n2dis1a.dat &
xmgrace mol_AR_avg.dat mol_AR_fluct.dat &
